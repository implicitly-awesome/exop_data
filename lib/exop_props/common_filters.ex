defmodule ExopProps.CommonFilters do
  ...
  """
  @spec filter(StreamData.t(), keyword()) :: StreamData.t()
  ...
  in parameter options given as the second argument.
  """
  @spec allow_nil(StreamData.t(), keyword()) :: StreamData.t()
  def allow_nil(generator, param_opts) do
    do_allow_nil(generator, Keyword.get(param_opts, :allow_nil))
  end
  ...
  in parameter options given as the second argument.
  """
  @spec not_in(StreamData.t(), keyword()) :: StreamData.t()
  def not_in(generator, param_opts) do
    do_not_in(generator, Keyword.get(param_opts, :not_in))
  end

  @spec do_allow_nil(StreamData.t(), keyword()) :: StreamData.t()
  ...
  @spec do_not_in(StreamData.t(), keyword()) :: StreamData.t()
